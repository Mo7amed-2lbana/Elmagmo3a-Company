...
const Expenses = () => {
  ...
  useEffect(() => {
    if (!getAllData && localStorage.getItem("dataExpenses") !== null) {
      setGetAllData(JSON.parse(localStorage.getItem("dataExpenses")));
    }
  }, [getAllData]);
  ...
  return (
    <>
      <section className="expenses py-5">
        <div className="container ">
          {/* Start Main Title  */}
          <MainTitle title={"  مصروفات الشهر الحالي"} />
          {/* Start Main Title  */}
