...
const AddPursh = () => {
  ...
  const addDataToState = useCallback((value) => {
    ...
    localStorage.setItem("dataPursh", JSON.stringify(allData));
  });
  ...
  useEffect(() => {
    if (localStorage.getItem("dataPursh") !== null && allData.length === 0) {
      setAllData(JSON.parse(localStorage.getItem("dataPursh")));
    }
  }, []);
  return (
    <>
              ...
              <div className="form-group mb-3 flex items-center">
                ...
                <div className="relative flex w-full">
                  {formik.values.proMonay ? (
                    <span className="absolute top-[50%] translate-y-[-50%] end-[15px]">
                      جنية
                    </span>
                  ) : (
                    ""
